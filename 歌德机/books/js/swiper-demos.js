...
function bookType(bookType, typeId) {
	...
	for (var i = 0; i < typeData.length; i++) {
		...
		//组成图书URL路径
		var app_url = _url + 'stores' + '/' + appId + '/' + app + '/' + 'assets' + '/' + 'www' + '/' + 'index.html?gedecache=2';
		//图书封面URL
		var cover_url = _url + 'stores' + '/' + appId + '/' + 'cover' + '/' + cover + '?gedecache=2';
		if (i % 8 == 0) {
    ...
    $('#' + typeId).html(str);
	var swiperLength=$(".swiper-wrapper").children(".swiper-slide").length+2;
