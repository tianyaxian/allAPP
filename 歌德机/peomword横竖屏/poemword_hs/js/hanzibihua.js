...
for(var book=0; book<books.list.length;book++){
	if(flag==1&&i==1){
		if(book==0){
			bookstr+='<div class="swiper-slide"><div class="videoBox"><ul><div class="leftIcon1"><p>'+willSort[0].fanweiNum+'</p></div></ul>';	 
			flag++;
		}
		else{
	...
	if(book>0){
		...
		if(flag==1&&i==1){
			if(chaoDaiType0!=chaoDaiType1){
				bookstr+='<ul><div class="leftIcon1"><p>'+willSort[book].fanweiNum+'</p></div></ul><ul class="ulHanZi clearfix">';
			...
			if(chaoDaiType0!=chaoDaiType1){
				...
				if(flag>12){
					bookstr+='</div></div><div class="swiper-slide"><div class="videoBox"><ul><div class="leftIcon1"><p>'+willSort[book].fanwei+'</p></div></ul><ul class="ulHanZi clearfix">';	
					flag=2;
					i=1;
				}else{	
					bookstr+='<ul><div class="leftIcon1"><p>'+willSort[book].fanwei+'</p></div></ul>';
	...
	if(i==5){
		...
		if(book!=willSort.length-1){
			var chaoDaiType1=willSort[book+1].fanweiNum;
			if(chaoDaiType0!=chaoDaiType1){i=1;}
		}
		bookstr+='</ul>';	
	}
