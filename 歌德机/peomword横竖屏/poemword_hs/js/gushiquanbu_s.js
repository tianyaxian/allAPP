...
for(var book=0; book<books.list.length;book++){
	...
	bookstr+='<li><input type="hidden" value="'+books.list[book].id+'"><a href="javascript:" ><img title="'+books.list[book].title+'" src="'+urlimg+books.list[book].id+imgType+'" /></a><p>'+books.list[book].title+'' +'</p>'+
		'<p>('+books.list[book].chaodai+'·'+books.list[book].author+')</p></li>'
