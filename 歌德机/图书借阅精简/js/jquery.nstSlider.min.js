...
(function($) {
    ...
    var _methods = {
        ...
        "set_handles_at_px": function(leftPx, rightPx) {
            ...
            if ($this.data("has_right_grip")) {
                $this.find(value_bar_selector).css("left", (leftPx + innerBarDeltaPx) + "px").css("width", (rightPx - leftPx + innerBarDeltaPx) + "px");
                $this.find(left_grip_selector).css("left", leftPx + "px")
            } else {
                if (leftPx < rightPx) {
                    $this.find(value_bar_selector).css("left", (leftPx + innerBarDeltaPx) + "px").css("width", (rightPx - leftPx + innerBarDeltaPx) + "px")
                } else {
                    $this.find(value_bar_selector).css("left", (rightPx + innerBarDeltaPx) + "px").css("width", (leftPx - rightPx + innerBarDeltaPx) + "px")
                }
                $this.find(left_grip_selector).css("left", leftPx + "px")
            }
        ...
        "init": function(options) {
            ...
            return this.each(function() {
                ...
                if (typeof settings.rounding !== "undefined") {
                    ...
                    if (typeof $this.data("rounding") !== "undefined") {
