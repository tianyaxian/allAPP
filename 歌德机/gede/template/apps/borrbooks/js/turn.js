(function($) {
    ...
    var has3d, vendor = '',
        ...
        turnMethods = {
            ...
            _turnPage: function(page) {
                ...
                if (data.pages[current]) {
                    ...
                    if (data.display == 'single') data.pages[current].flip('turnPage', (newView[0] > view[0]) ? 'br': 'bl');
            ...
            _start: function(e, opts, corner) {
                ...
                if (data.display == 'single') {
                    ...
                    if ((opts.page == 1 && left) || (opts.page == data.totalPages && !left)) e.preventDefault();
                    else {
                        if (left) {
                ...
                if (data.pageMv.length && data.pageMv[0] !== 0) {
                    ...
                    for (page in data.pageWrap) {
                        ...
                        if (data.pages[page]) {
                            ...
                            if (data.tpage) data.pages[page].flip('disable', true)
                        }
                    }
                } else {
                    for (page in data.pageWrap) {
        ...
        flipMethods = {
            ...
            _foldingPage: function(corner) {
                ...
                if (opts.folding) return opts.folding;
                    ...
                    var data = opts.turn.data();
                    if (data.display == 'single') return (data.pageObjs[opts.next]) ? data.pageObjs[0] : null;
            ...
            _fold: function(point) {
                var that = this,
                    a = 0,
                    alpha = 0,
                    beta, px, gradientEndPointA, gradientEndPointB, gradientStartV, gradientSize, gradientOpacity, mv = point2D(0, 0),
                    df = point2D(0, 0),
                    tr = point2D(0, 0),
                    width = this.width(),
                    height = this.height(),
        ...
        cla = function(that, methods, args) {
            ...
            else if (methods[args[0]] && args[0].toString().substr(0, 1) != '_') return methods[args[0]].apply(that, Array.prototype.slice.call(args, 1));
